...
main (int argc, char *argv[])
{
  ...
  Ptr<ConstantPositionMobilityModel> enb5 = DynamicCast<ConstantPositionMobilityModel>(enbNodes.Get(5)->GetObject<MobilityModel> ());
  Ptr<ConstantPositionMobilityModel> enb6 = DynamicCast<ConstantPositionMobilityModel>(enbNodes.Get(6)->GetObject<MobilityModel> ());
  Ptr<ConstantPositionMobilityModel> enb7 = DynamicCast<ConstantPositionMobilityModel>(enbNodes.Get(7)->GetObject<MobilityModel> ());
  Ptr<ConstantPositionMobilityModel> enb8 = DynamicCast<ConstantPositionMobilityModel>(enbNodes.Get(8)->GetObject<MobilityModel> ());
	
  enb0->SetPosition(Vector(0,0,1.6));
  enb1->SetPosition(Vector(211.498,18.2029,1.6)); 
  enb2->SetPosition(Vector(400,0,1.6));
  enb3->SetPosition(Vector(11.3678,231.443,1.6));
  enb4->SetPosition(Vector(250,250,1.6));
  enb5->SetPosition(Vector(380.225,195.827,1.6));
  enb6->SetPosition(Vector(0,400,1.6));
  enb7->SetPosition(Vector(184.291,387.265,1.6));
  enb8->SetPosition(Vector(400,400,1.6));
...
m11->SetPosition(Vector(400,400,1.6)); 
  ...
  rlcStats->SetAttribute ("DlRlcOutputFilename", StringValue ("Throughput_bsDist_1168.txt"));
